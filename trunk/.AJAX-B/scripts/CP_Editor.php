<html>
	...
	<script type="text/javascript" src="./.AJAX-B/codepress/codepress.js" ></script>
...
<?php
foreach (glob ('./.AJAX-B/codepress/languages/*.css') as $key=>$val)
{
	$lst_mod[] = '
...
<span id="Mcolor" onmouseover="this.childNodes[3].style.display='block';" onmouseout="this.childNodes[3].style.display='none';">
	<img src="./.AJAX-B/icones/MiniMenu.png">
	<table id="colorlst" class="menu">
	<?php echo implode ("\n",$lst_mod); ?>
	</table>
</span>
<span id="Msave" onclick="alert(CP.getCode());">
	<img src="./.AJAX-B/icones/Download.png">
</span>
