...
?>
	<span class="close">
		...
		<span style='padding:2px;'><a href="./.AJAX-B/Documentation.txt">Documentation</a></span>
	</span>
...
class ACT_LNK
{
	...
	$SOURCE	=	new ACT_LNK (1, "./.AJAX-Ico/View.png", "Source(SelFile);", "Ouvrir ce fichier...");
	$EDIT	=	new ACT_LNK (3, "./.AJAX-Ico/Edit.png", "Edit(SelFile);", "Editer en mode Texte");
	...
	$BAR_LST = compact("NEW", "REN", "DEL", "DOWNLOAD", "UPLOAD", "MAIL");
	...
	echo "<table id='MAM' class='width'><colgroup> <col width='180'><col><col width='150'></colgroup><tbody><tr><td style='padding-top:2px;'>";
