...
<div id='page'>
  <div id='download'>
    <h3><?php echo _('<em>Pro</em> version'); ?></h3>
    <div id='dwl-pro'>
    ...
    <h3><?php echo _('<em>Free</em> version'); ?></h3>
    <div id='dwl-free'>
      <?php echo snippets_latest_free(); ?>
      <p><?php echo _("The <em>free</em> version keep main features as shown on the <a href='?p=Features#comparison'>versions comparison</a> table. You can use and redistribute it under the GNU GPL licence. All pro versions are listed below (newest first)&thinsp;:"); ?></p>
      <dl class='mark inl'>
    ...
    <h3><?php echo _('Languages pack'); ?></h3>
    <div id='dwl-lang'>
