...
function _upload()
{
	PtrWindow = window.open(ServActPage+"?mode=request&dest="+getDest()+'&upload=', getDest(),"menubar=no,toolbar=no,tabbar=no,locationbar=no,resizable,scrollbars,status,top=0,left=0,width=550,height=300");
	if (PtrWindow === null) {alert (ABS907);}
